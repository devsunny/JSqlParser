...
public class CCJSqlParser implements CCJSqlParserConstants {
        ...
        private final static Map<String, Character> CHAR_MAP = new CaseInsensitiveMap<Character>();
        static{
                CHAR_MAP.put("\u005ct", '\u005ct');
                CHAR_MAP.put("\u005cn", '\u005cn');
                CHAR_MAP.put("\u005cf", '\u005cf');
                CHAR_MAP.put("\u005cb", '\u005cb');
                CHAR_MAP.put("\u005cr", '\u005cr');
                CHAR_MAP.put("NEWLINE", '\u005cn');
                CHAR_MAP.put("PIPE", '|');
                CHAR_MAP.put("TAB", '\u005ct');
                CHAR_MAP.put("COMMA", ',');
                CHAR_MAP.put("COLON", ':');
                CHAR_MAP.put("SEMICOLON", ';');
                CHAR_MAP.put("HASH", '#');
                CHAR_MAP.put("TILDE", '~');
                CHAR_MAP.put("HASH", '#');
                CHAR_MAP.put("CARET", '^');
        }
        protected static char getTerminatorChar(String img) throws ParseException
        {
                String charStr = new StringValue(img).getValue();
                if(charStr.length()==1){
                        return charStr.charAt(0);
                }else if(CHAR_MAP.containsKey(charStr)){
                        return CHAR_MAP.get(charStr);
                }else if (charStr.matches("^\u005c\u005cd+$")){
                        return (char)Integer.valueOf(charStr.substring(1)).intValue();
                }else{
                        throw new ParseException("Invalid delimiter String:" + charStr);
                }
        }
...
table=new Table(new StringValue(tok.image).getValue());
      break;
      }
    default:
      jj_la1[16] = jj_gen;
    ...
    default:
      ...
      if (jj_2_48(2147483647)) {
        ...
        case 163:{
          switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
          case 162:{
            sign = jj_consume_token(162);
            break;
            }
          case 163:{
            sign = jj_consume_token(163);
            break;
            }
          default:
            jj_la1[152] = jj_gen;
...
index.setColumnsNames(colNames);
  ...
  final public CreateTable CreateTable() throws ParseException {CreateTable createTable = new CreateTable();
        ...
        List partitionedBys = new ArrayList();
        Token columnName;
        Token tk = null;
        Token tk2 = null;
        Token tk3 = null;
...
partitionedBys.add(partitionedBy);
          break;
          }
        default:
          jj_la1[216] = jj_gen;
      ...
      case K_ROW:{
        rowFormat = RowFormat();
createTable.setRowFormat(rowFormat);
        break;
        }
      default:
        jj_la1[217] = jj_gen;
...
createTable.setFileFormat(fileFormat);
        break;
        }
      default:
        jj_la1[218] = jj_gen;
      ...
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case K_LOCATION:{
        jj_consume_token(K_LOCATION);
        tk3 = jj_consume_token(S_CHAR_LITERAL);
createTable.setLocation(tk3.image);
        break;
        }
      default:
        jj_la1[219] = jj_gen;
...
createTable.setTable(table);
                ...
                if(partitionedBys.size()>0)
                        createTable.setPartitionedBys(partitionedBys);
                {if ("" != null) return createTable;}
    throw new Error("Missing return statement in function");
  }

  final public RowFormat RowFormat() throws ParseException {RowFormat rformat = new RowFormat();
        Token rfTok = null;
    jj_consume_token(K_ROW);
    jj_consume_token(K_FORMAT);
    jj_consume_token(K_DELIMITED);
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case K_FIELDS:{
      jj_consume_token(K_FIELDS);
      jj_consume_token(K_TERMINATED);
      jj_consume_token(K_BY);
      rfTok = jj_consume_token(S_CHAR_LITERAL);
rformat.setFieldTerminator(getTerminatorChar(rfTok.image));
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case K_ESCAPED:{
        jj_consume_token(K_ESCAPED);
        jj_consume_token(K_BY);
        rfTok = jj_consume_token(S_CHAR_LITERAL);
rformat.setEscapedBy(getTerminatorChar(rfTok.image));
        break;
        }
      default:
        jj_la1[221] = jj_gen;
    ...
    case K_COLLECTION:{
      ...
      jj_consume_token(K_ITEMS);
      jj_consume_token(K_TERMINATED);
      jj_consume_token(K_BY);
      rfTok = jj_consume_token(S_CHAR_LITERAL);
rformat.setCollectionItemTerminator(getTerminatorChar(rfTok.image));
      break;
      }
    default:
      jj_la1[223] = jj_gen;
    ...
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case K_MAP:{
      jj_consume_token(K_MAP);
      jj_consume_token(K_KEYS);
      jj_consume_token(K_TERMINATED);
      jj_consume_token(K_BY);
      rfTok = jj_consume_token(S_CHAR_LITERAL);
rformat.setMapKeysTerminator(getTerminatorChar(rfTok.image));
      break;
      }
    default:
      jj_la1[224] = jj_gen;
    ...
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case K_LINES:{
      jj_consume_token(K_LINES);
      jj_consume_token(K_TERMINATED);
      jj_consume_token(K_BY);
      rfTok = jj_consume_token(S_CHAR_LITERAL);
rformat.setLineTerminator(getTerminatorChar(rfTok.image));
      break;
      }
    default:
      jj_la1[225] = jj_gen;
    ...
    case K_NULL:{
      jj_consume_token(K_NULL);
      jj_consume_token(K_DEFINED);
      jj_consume_token(K_AS);
      rfTok = jj_consume_token(S_CHAR_LITERAL);
rformat.setNullDefinedAs(getTerminatorChar(rfTok.image));
      break;
      }
    default:
      jj_la1[226] = jj_gen;
...
{if ("" != null) return rformat;}
    throw new Error("Missing return statement in function");
  }

  final public FileFormat FileFormat() throws ParseException {FileFormat ff = new FileFormat();
        Token rfTok = null;
    jj_consume_token(K_STORED);
    jj_consume_token(K_AS);
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case K_SEQUENCEFILE:{
      rfTok = jj_consume_token(K_SEQUENCEFILE);
      break;
      }
    case K_TEXTFILE:{
      rfTok = jj_consume_token(K_TEXTFILE);
      break;
      }
    case K_RCFILE:{
      rfTok = jj_consume_token(K_RCFILE);
      break;
      }
    case K_ORC:{
      rfTok = jj_consume_token(K_ORC);
      break;
      }
    case K_PARQUET:{
      rfTok = jj_consume_token(K_PARQUET);
      break;
      }
    case K_AVRO:{
      rfTok = jj_consume_token(K_AVRO);
      break;
      }
    case K_INPUTFORMAT:{
      rfTok = jj_consume_token(K_INPUTFORMAT);
      break;
      }
    default:
      jj_la1[227] = jj_gen;
...
ff.setFormatName(rfTok.image);
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case S_CHAR_LITERAL:{
      rfTok = jj_consume_token(S_CHAR_LITERAL);
ff.setInputFormatClass(new StringValue(rfTok.image).getValue());
      break;
      }
    default:
      jj_la1[228] = jj_gen;
...
{if ("" != null) return ff;}
  ...
  final public PartitionedBy PartitionedBy() throws ParseException {PartitionedBy partitionedBy = new PartitionedBy();
        List columnDefinitions = new ArrayList();
        List columnSpecs = null;
        Token columnName;
        Token parameter;
        ColDataType colDataType = null;
        ColumnDefinition coldef = null;
    jj_consume_token(K_PARTITIONED);
    jj_consume_token(K_BY);
    jj_consume_token(142);
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case S_IDENTIFIER:{
...
columnSpecs = new ArrayList();
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case S_CHAR_LITERAL:{
      parameter = jj_consume_token(S_CHAR_LITERAL);
columnSpecs.add(parameter.image);
      break;
      }
    default:
      jj_la1[230] = jj_gen;
...
columnSpecs = new ArrayList();
      ...
      case S_CHAR_LITERAL:{
        parameter = jj_consume_token(S_CHAR_LITERAL);
columnSpecs.add(new StringValue(parameter.image).getValue());
        break;
        }
      default:
        jj_la1[233] = jj_gen;
...
coldef = new ColumnDefinition();
    ...
    jj_consume_token(143);
partitionedBy.setPartitionDefinitions(columnDefinitions);
                        {if ("" != null) return partitionedBy;}
    throw new Error("Missing return statement in function");
  }
...
{if ("" != null) return createView;}
  ...
  final public String CreateParameter() throws ParseException {String retval = null;
        Token tk = null;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case S_IDENTIFIER:{
      tk = jj_consume_token(S_IDENTIFIER);
...
{if ("" != null) return truncate;}
  ...
  final public Set Set() throws ParseException {Set set = new Set();
        String settingName;
    jj_consume_token(K_SET);
    settingName = RelObjectName();
set.setName(settingName);
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case K_TO:
    case 140:{
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
...
{if ("" != null) return set;}
  ...
  final public Show Show() throws ParseException {Show show = new Show();
    jj_consume_token(K_SHOW);
    token = jj_consume_token(S_IDENTIFIER);
show.setName(token.image);
{if ("" != null) return show;}
    throw new Error("Missing return statement in function");
  }
  ...
  private boolean jj_3R_328()
 {
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x20,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x20,0x0,0x0,0x20,0x20,0x0,0x0,0x0,0x0,0x20,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x20,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x20,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x80,0x80,0x0,0x200,0x100,0x0,0x4000,0x1000,0x8000,0x20000,0x80000,0x0,0xfe00000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x80000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x8000000,0x8040,0x0,0x0,0x80000,0x40000000,0x1000,0x0,0x0,0x0,0x0,0x0,0x0,0x40,0x1000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x80000,0x40000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x8000000,0x0,0x1,0x2,0x2,0x100,0x1000,0x80000,0x40000000,0x0,0x0,0x0,0x0,0x2,0x2,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x202000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x8,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x202000,0x0,0x0,0x0,0x4070000,0x4060000,0x4060000,0x0,0x0,0x10000,0x0,0x1,0x1,0x0,0x0,0x0,0x0,0x0,0x880,0x880,0x0,0x0,0x0,0x0,0x0,0x0,0x2,0x0,0x0,0x0,0x0,0x200,0x0,0x20,0x20,0x20,0x20,0x0,0x0,0x20,0x0,0x0,0x0,0x0,0x202000,0x0,0x202000,0x0,0x202000,0x20,0x202000,0x20,0x20,0x0,0x20,0x202020,0x20,0x0,0x0,0x220200a,0x2000008,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x202000,0x0,0x0,0x0,0x0,0x202000,0x202000,0x0,0x0,0x0,0x0,0x0,0x202000,0x0,0x0,0x202000,0x400000,0x1000000,0x400000,0x1000000,0x602000,0x0,0x0,0x0,0x0,0x2,0x2,0x202000,0x202002,0x0,0x2030,0x0,0x28b0,0x28b0,0x0,0x0,0x28b0,0x28b0,0x2030,0x2030,0x0,0x2030,0x0,0x0,0x0,0x0,0x2030,0x0,0x10,0x2030,0x2030,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x2000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x2030,0x0,0x0,0x0,0x0,0x10000000,0x0,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0x0,0x218a000,0x8000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x201000,0x201000,0x0,0x8000,0x209000,0x0,0x0,0x0,0x201000,0x201000,0x0,0x0,0x0,0x0,0x8000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x8000,0x0,0x10000000,0x10000000,0x0,0x0,0x0,0x0,0x0,0x10,0x40000,0x8000,0x10000000,0x10000000,0xa0000008,0x8000,0xa0000008,0x400,0x10100,0x0,0x0,0x0,0x0,0x0,0x4a000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x8000,0x0,0x0,0x8000,0x0,0x1,0x1,0x0,0x0,0x0,0x0,0x0,0x0,0x4a000000,0x0,0x0,0x0,0x1000a80,0x1000800,0x1000800,0x280,0x280,0x0,0x0,0x4,0x4,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x10100,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xa000000,0x0,0x0,0x0,0x0,0x0,0x0,0x4a000000,0x0,0x4a000000,0x0,0x4a000000,0x0,0x4a000000,0x0,0x0,0x400000,0x0,0x4a000000,0x0,0x0,0x0,0x4a000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x4a000000,0x4a000000,0x0,0x0,0x0,0x400,0x0,0x4e000000,0x0,0x0,0x4a000000,0x0,0x0,0x0,0x0,0x4a000000,0x0,0xa000000,0x0,0x0,0x10000000,0x10000000,0x4a000000,0x5a000000,0x0,0x800000,0x0,0x800000,0x800000,0x0,0x0,0x800000,0x800000,0x800000,0x800000,0x0,0x800000,0x0,0x0,0x0,0x0,0x800000,0x40,0x0,0x800000,0x800000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x800000,0x0,0x0,0x0,0x0,0x40,0x0,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_3() {
      jj_la1_3 = new int[] {0x0,0x20000,0x80000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x3000,0x0,0x0,0x0,0x0,0x0,0x1,0x0,0x1,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x48,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x10,0x0,0x0,0x0,0x10,0x0,0x0,0x0,0x0,0x48,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1000,0x8000,0x0,0x10000,0x0,0x0,0x0,0x600000,0x600000,0x100000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x4000,0x0,0x0,0x0,0x4000,0x0,0x48,0x0,0x48,0x0,0x48,0x0,0x48,0x0,0x0,0x0,0x0,0x48,0x0,0x0,0x0,0x48,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x40,0x0,0x0,0x0,0x48,0x48,0x0,0x4,0x1800000,0x0,0x1800000,0x12000048,0xc000000,0xc000000,0x12000048,0x0,0x0,0x0,0x0,0x48,0x0,0x0,0x0,0x0,0x0,0x0,0x48,0x48,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x100,0x100,0x0,0x0,0x0,0x180,0x0,0x0,0x20000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x400,0x0,0x0,0x0,0x400,0x0,0x20,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x40000000,0x40000000,0x0,0x0,};
   }
   private static void jj_la1_init_4() {
      jj_la1_4 = new int[] {0x800,0x4000,0x0,0x800,0x2000,0x0,0x0,0x0,0x2000,0x2000,0x0,0x0,0x2000,0x4000,0x4000,0x0,0x320,0x2000,0x0,0x0,0x2000,0x2000,0x2000,0x8000,0x4000,0x0,0x0,0x220,0x220,0x220,0x220,0x220,0x220,0x220,0x220,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x4000,0x0,0x0,0x0,0x4000,0x0,0x0,0x0,0x2000,0x4000,0x2000,0x220,0x20000,0x44323,0x0,0x220,0x2000,0x4220,0x2000,0x2000,0x220,0x2000,0x4000,0x4000,0x4000,0x2000,0x4000,0x4220,0x0,0x0,0x220,0x4220,0x2000,0x2000,0x2000,0x2000,0x44323,0x2000,0x4000,0x220,0x2000,0x0,0x0,0x0,0x0,0x2000,0x2000,0x0,0x0,0x0,0x0,0x2000,0x0,0x2000,0x0,0x0,0x0,0x0,0x0,0x40002,0x40002,0x40002,0x40002,0x40002,0x0,0x40002,0x44002,0x0,0x4000,0x0,0x4000,0x0,0x4000,0x220,0x0,0x0,0x80000,0x7ff01000,0x0,0x80000,0x44323,0x80000,0x44323,0x80000,0x44323,0x0,0x44323,0x0,0x0,0x0,0x0,0x44323,0x0,0x2000,0x2000,0x44323,0x0,0x4000,0x80000000,0x0,0x0,0x4000,0x20000,0x4000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x40000,0x4100,0x0,0x2000,0x2000,0x64323,0x64323,0x2000,0x0,0x0,0x0,0x0,0x44323,0x0,0x0,0x44323,0x0,0x0,0x0,0x0,0x44323,0x0,0x220,0x10000,0x10000,0x0,0x0,0x64323,0x64323,0x0,0x5123,0x220,0x5123,0x5123,0x2000,0x220,0x5123,0x5123,0x5123,0x5123,0x220,0x5123,0x2000,0x0,0x0,0x220,0x5123,0x0,0x220,0x5123,0x5123,0x0,0x0,0x0,0x4000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x100,0x220,0x100,0x2000,0x220,0x100,0x20,0x102,0x102,0x2000,0x0,0x0,0x0,0x4000,0x4000,0x5123,0x123,0x123,0x2000,0x2000,0x20,0x20,0x1000,0x1000,0x103,0x220,};
   }
   private static void jj_la1_init_5() {
      jj_la1_5 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x368c,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x368c,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x2000,0x0,0x0,0x0,0x0,0x0,0x0,0x368c,0x0,0x368c,0x0,0x368c,0x0,0x368c,0x0,0x0,0x0,0x0,0x368c,0x0,0x0,0x0,0x368c,0x0,0x0,0x0,0x3,0xc,0x0,0x30,0x0,0x40,0xc,0xc,0xc,0xc,0xc,0xc,0xc,0xc,0xc,0xc,0xc,0xc,0xc,0xc,0x1000,0x68c,0x800,0x0,0x0,0x368c,0x368c,0x0,0x0,0x0,0x0,0x0,0x368c,0x0,0x0,0x368c,0x0,0x0,0x0,0x0,0x368c,0x2000,0x0,0x0,0x0,0x0,0x0,0x368c,0x368c,0x100,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
  ...
  public CCJSqlParser(java.io.InputStream stream, String encoding) {
    ...
    jj_ntk = -1;
    jj_gen = 0;
    for (int i = 0; i < 254; i++) jj_la1[i] = -1;
